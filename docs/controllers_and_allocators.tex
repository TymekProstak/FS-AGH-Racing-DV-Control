...
\end{itemize}
All packages share the unbounded LTV MPC lateral controller. In the main
package, the forward--backward (BF) profile generates the longitudinal
reference.
...
The unit test \path{common/test/load_transfer_test.cpp} checks the exact filter
response after one $\tau$, conservation of total normal force,
